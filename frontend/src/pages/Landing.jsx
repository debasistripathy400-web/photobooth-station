...
const Landing = () => {
    return (
        <div className="relative overflow-hidden pt-28 sm:pt-36 pb-16 sm:pb-24 px-4 sm:px-6">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-20 items-center text-center lg:text-left">
                <motion.div
                ...
                >
                    ...
                    <h1 className="text-5xl sm:text-7xl md:text-8xl font-black mb-6 sm:mb-8 leading-[0.9] tracking-tighter">
                        AI <span className="neon-text-purple">PHOTO</span><br />
                        <span className="neon-text-blue italic">STATION.</span>
                    </h1>

                    <p className="text-base sm:text-lg text-gray-400 mb-8 sm:mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center lg:justify-start">
                        <Link to="/booth" className="btn-neon group flex items-center justify-center gap-2 py-4">
                            Enter Booth <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <Link to="/gallery" className="px-6 py-4 rounded-full border border-white/10 hover:border-brand-neon-blue transition-colors text-sm font-bold flex items-center justify-center gap-2">
                            Browse Gallery <LayoutGrid className="w-4 h-4 opacity-50" />
                        </Link>
                    </div>

                    <div className="mt-12 sm:mt-16 flex items-center justify-center lg:justify-start gap-8 sm:gap-12 opacity-40">
                        <div className="flex flex-col gap-1">
                            <span className="text-xl sm:text-2xl font-black">10K+</span>
                            <span className="text-[8px] sm:text-[10px] uppercase tracking-widest font-bold">Captures</span>
                        </div>
                        <div className="flex flex-col gap-1">
                            <span className="text-xl sm:text-2xl font-black">25+</span>
                            <span className="text-[8px] sm:text-[10px] uppercase tracking-widest font-bold">AI Filters</span>
                        </div>
                        <div className="flex flex-col gap-1">
                            <span className="text-xl sm:text-2xl font-black">100%</span>
                            <span className="text-[8px] sm:text-[10px] uppercase tracking-widest font-bold">Client-Side</span>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="absolute -inset-6 sm:-inset-10 bg-brand-neon-purple/20 blur-[60px] sm:blur-[100px] rounded-full" />
                    <div className="relative glass rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden border border-white/10 p-2 sm:p-4 shadow-2xl">
                        <div className="relative aspect-[4/5] bg-neutral-900 rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden group">
                            <img 
